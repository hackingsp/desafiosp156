...
Para quem já possui prática com ferramentas de integração contínua, integramos nosso repositório no Travis CI: [https://travis-ci.org/profile/hackingsp](https://travis-ci.org/profile/hackingsp)
